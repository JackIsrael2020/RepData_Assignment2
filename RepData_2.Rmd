...
g + geom_bar(stat = "identity", color = "steel blue") + ylab("Fatalities") +
  xlab("Weather Event Type")+ theme(axis.text.x = element_text(size=6, angle=90)) +
...
Check2 <- aggregate(X4$PROPDMG, by = list('EventType' = X4$EVTYPE), sum) %>% arrange(x)
